...
<?php else: ?>
<a class="fix-btn" href="<?php echo $home; ?>/kowarsu/"><img src="<?php echo $wp_url; ?>/dist/images/fix_btn_sp.png" alt="" srcset="<?php echo $wp_url; ?>/dist/images/fix_btn_sp.png 1x, <?php echo $wp_url; ?>/dist/images/fix_btn_sp@2x.png 2x"></a>
<?php endif; ?>
<?php wp_footer(); ?>
</body>
</html>
